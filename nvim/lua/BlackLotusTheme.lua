...
-- Vim Editor Color --
----------------------
Group.new('Normal',       c.fg1,          c.none,         no)
...
Group.new('ModeMsg',      c.fg1,          c.none,         no)
...
Group.new('bg3Thumb',     c.none,         c.fg1,          no)
...
Group.new('StatusLine',   c.fg1,          c.dark_blue,    no)
...
Group.new('Title',        c.fg1,          c.none,         b)
...
Group.new('WildMenu',     c.fg1,          c.fg3,          no)
...
Group.new('helpHeader',       c.fg1,     c.none,  b)
...
Group.new('cssInclude',           c.fg1,          c.none,  no)
...
Group.new('sassFor',              c.fg1,          c.none,  no)
...
Group.new('sassMediaOperators',   c.fg1,          c.none,  no)
...
-- JSON
Group.new('jsonCommentError',       c.fg1,     c.none, no)
...
Group.new('purescriptModuleName',  c.fg1,      c.none, no)
Group.new('purescriptIdentifier',  c.fg1,      c.none, no)
...
Group.new('purescriptOperator',    c.fg1,      c.none, no)
...
-- ZSH
Group.new('zshCommands',    c.fg1,          c.none, no)
...
Group.new('CocFloating', c.fg1, c.none, no)
Group.new('NormalFloat', c.fg1, c.bg3,  no)
-----------------------------
--     LSP Highlighting    --
-----------------------------
...
--     CMP Highlighting    --
-----------------------------
Group.new('CmpNormal',    c.fg1, c.bg2, no)
Group.new('CmpDocNormal', c.fg1, c.bg2, no)

-----------------------------
--     BarBar Support      --
-----------------------------
-- In Progress
Group.new('BufferAlternate',          c.fg1,   c.bg1, no)
Group.new('BufferAlternateSign',      c.fg1,   c.bg1, no)
Group.new('BufferAlternateSignRight', c.fg1,   c.bg1, no)

Group.new('BufferCurrent',          c.blue, c.bg4, no)
Group.new('BufferCurrentSign',      c.bg1,   c.bg4, no)
Group.new('BufferCurrentSignRight', c.bg2,  c.bg4, no)
Group.new('BufferCurrentIcon',      c.none, c.bg4, no)


Group.new('BufferInactive',           c.fg1,   c.bg1, no)
Group.new('BufferAlternateSign',      c.fg1,   c.bg1, no)
Group.new('BufferAlternateSignRight', c.fg1,   c.bg1, no)

Group.new('BufferVisible',            c.fg1,   c.bg1, no)
Group.new('BufferAlternateSign',      c.fg1,   c.bg1, no)
Group.new('BufferAlternateSignRight', c.fg1,   c.bg1, no)
...
Group.new('TSOperator',           c.fg1,          c.none, no)
...
Group.new('TSPunctBracket',       c.fg1,          c.none, no)
Group.new('TSPunctDelimiter',     c.fg1,          c.none, no)
Group.new('TSPunctSpecial',       c.fg1,          c.none, no)
